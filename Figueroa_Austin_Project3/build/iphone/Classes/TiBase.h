...
// in simulator we redefine to format for Figueroa_Austin_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.figueroa_austin_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.figueroa_austin_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFigueroa_Austin_Project3NativeItemNone = -1, 
	UIFigueroa_Austin_Project3NativeItemSpinner = -2,
	UIFigueroa_Austin_Project3NativeItemProgressBar = -3,
	
	UIFigueroa_Austin_Project3NativeItemSlider = -4,
	UIFigueroa_Austin_Project3NativeItemSwitch = -5,
	UIFigueroa_Austin_Project3NativeItemMultiButton = -6,
	UIFigueroa_Austin_Project3NativeItemSegmented = -7,
	
	UIFigueroa_Austin_Project3NativeItemTextView = -8,
	UIFigueroa_Austin_Project3NativeItemTextField = -9,
	UIFigueroa_Austin_Project3NativeItemSearchBar = -10,
	
	UIFigueroa_Austin_Project3NativeItemPicker = -11,
	UIFigueroa_Austin_Project3NativeItemDatePicker = -12,
	
	UIFigueroa_Austin_Project3NativeItemInfoLight = -13,
	UIFigueroa_Austin_Project3NativeItemInfoDark = -14,
	
	UIFigueroa_Austin_Project3NativeItemDisclosure = -15,
	
	UIFigueroa_Austin_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Figueroa_Austin_Project3 instances of

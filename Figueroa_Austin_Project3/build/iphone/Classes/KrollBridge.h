...
@interface Figueroa_Austin_Project3Object : KrollCoverageObject {
#else
@interface Figueroa_Austin_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Figueroa_Austin_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Figueroa_Austin_Project3Object *_figueroa_austin_project3;
    KrollObject* console;
	BOOL shutdown;

...
//@interface Figueroa_Austin_Project3Object : NSObject
//@end

@interface Figueroa_Austin_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Figueroa_Austin_Project3Object class]])
		{
			for (NSString *key in [[(Figueroa_Austin_Project3Object*)o modules] allKeys])
			{

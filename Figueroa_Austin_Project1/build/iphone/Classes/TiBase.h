...
// in simulator we redefine to format for Figueroa_Austin_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.figueroa_austin_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.figueroa_austin_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFigueroa_Austin_Project1NativeItemNone = -1, 
	UIFigueroa_Austin_Project1NativeItemSpinner = -2,
	UIFigueroa_Austin_Project1NativeItemProgressBar = -3,
	
	UIFigueroa_Austin_Project1NativeItemSlider = -4,
	UIFigueroa_Austin_Project1NativeItemSwitch = -5,
	UIFigueroa_Austin_Project1NativeItemMultiButton = -6,
	UIFigueroa_Austin_Project1NativeItemSegmented = -7,
	
	UIFigueroa_Austin_Project1NativeItemTextView = -8,
	UIFigueroa_Austin_Project1NativeItemTextField = -9,
	UIFigueroa_Austin_Project1NativeItemSearchBar = -10,
	
	UIFigueroa_Austin_Project1NativeItemPicker = -11,
	UIFigueroa_Austin_Project1NativeItemDatePicker = -12,
	
	UIFigueroa_Austin_Project1NativeItemInfoLight = -13,
	UIFigueroa_Austin_Project1NativeItemInfoDark = -14,
	
	UIFigueroa_Austin_Project1NativeItemDisclosure = -15,
	
	UIFigueroa_Austin_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Figueroa_Austin_Project1 instances of

...
@interface Figueroa_Austin_Project1Object : KrollCoverageObject {
#else
@interface Figueroa_Austin_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Figueroa_Austin_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Figueroa_Austin_Project1Object *_figueroa_austin_project1;
    KrollObject* console;
	BOOL shutdown;

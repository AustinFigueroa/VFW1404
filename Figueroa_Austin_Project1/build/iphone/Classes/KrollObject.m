...
//@interface Figueroa_Austin_Project1Object : NSObject
//@end

@interface Figueroa_Austin_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Figueroa_Austin_Project1Object class]])
		{
			for (NSString *key in [[(Figueroa_Austin_Project1Object*)o modules] allKeys])
			{

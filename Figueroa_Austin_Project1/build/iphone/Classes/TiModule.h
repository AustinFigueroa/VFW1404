...
/**
 The base class for all Figueroa_Austin_Project1 modules
 */
...
/**
 Figueroa_Austin_Project1 Platform calls this method on startup.
 */
-(void)startup;

/**
 Figueroa_Austin_Project1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Figueroa_Austin_Project1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Figueroa_Austin_Project1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Figueroa_Austin_Project1 Platform calls this method on resume.
 @param sender The sender of the event.
 */

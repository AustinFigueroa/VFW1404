...
// in simulator we redefine to format for Figueroa_Austin_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.figueroa_austin_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.figueroa_austin_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFigueroa_Austin_Project2NativeItemNone = -1, 
	UIFigueroa_Austin_Project2NativeItemSpinner = -2,
	UIFigueroa_Austin_Project2NativeItemProgressBar = -3,
	
	UIFigueroa_Austin_Project2NativeItemSlider = -4,
	UIFigueroa_Austin_Project2NativeItemSwitch = -5,
	UIFigueroa_Austin_Project2NativeItemMultiButton = -6,
	UIFigueroa_Austin_Project2NativeItemSegmented = -7,
	
	UIFigueroa_Austin_Project2NativeItemTextView = -8,
	UIFigueroa_Austin_Project2NativeItemTextField = -9,
	UIFigueroa_Austin_Project2NativeItemSearchBar = -10,
	
	UIFigueroa_Austin_Project2NativeItemPicker = -11,
	UIFigueroa_Austin_Project2NativeItemDatePicker = -12,
	
	UIFigueroa_Austin_Project2NativeItemInfoLight = -13,
	UIFigueroa_Austin_Project2NativeItemInfoDark = -14,
	
	UIFigueroa_Austin_Project2NativeItemDisclosure = -15,
	
	UIFigueroa_Austin_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Figueroa_Austin_Project2 instances of

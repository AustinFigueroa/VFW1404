...
@interface Figueroa_Austin_Project2Object : KrollCoverageObject {
#else
@interface Figueroa_Austin_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Figueroa_Austin_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Figueroa_Austin_Project2Object *_figueroa_austin_project2;
    KrollObject* console;
	BOOL shutdown;

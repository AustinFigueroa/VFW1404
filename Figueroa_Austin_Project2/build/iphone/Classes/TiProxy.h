...
//Rare exceptions to indicate a bug in the _figueroa_austin_project2 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Figueroa_Austin_Project2 proxies.
 */

...
//@interface Figueroa_Austin_Project2Object : NSObject
//@end

@interface Figueroa_Austin_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Figueroa_Austin_Project2Object class]])
		{
			for (NSString *key in [[(Figueroa_Austin_Project2Object*)o modules] allKeys])
			{
